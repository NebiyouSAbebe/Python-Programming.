...
"""
#%%
def problem3_1(textfilenames):
    """ Opens file and prints its contents line by line."""
    infile = open(textfilenames)
...
def problem3_3(month, day, year):
    ...
    monthStr = int(months) - 1
    print(str(months[monthStr], str(day) + ",", year)
...
or cmd.exe), it won't be runnable as our usual functions are by entering Shift-Enter.  
You should use the File menu in Spyder to create you own file.
